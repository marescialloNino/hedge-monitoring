...
class BingxMarket(MotherFeeder):
    ...
    def _init_API(self):
        ...
        if self.account == 0:
            ...
            self.__API_KEY = os.environ['BINGX_PAIRSPREAD1_API_KEY']
            self.__API_SEC = os.environ['BINGX_PAIRSPREAD1_API_SECRET']
